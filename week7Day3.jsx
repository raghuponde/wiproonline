...
Value : {this.state.inputFeedback}// to see i had added this
    ...
    local storage demo udated code 
    ----------------------------------
    import React from "react";
import { getRandomUser } from "./Utility/api";
class CyclOPediaClassPage extends React.Component {
...
export default CyclOPediaClassPage;
    ...
    Now  i want to move instrctor details into seperate page and one value i will show 


    add ome file Instructor.jsx and code for that 
    ----------------------------------------------
...
in cycloPediaclas page 
    --------------------
    in the retun after first div 
